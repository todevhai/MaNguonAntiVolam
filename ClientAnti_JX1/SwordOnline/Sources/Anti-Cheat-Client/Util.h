...
#define KEY_ENCRYPT "44da4f55@9cfd62858#6894e86f7e2!eb09"
#define IV_ENCRYPT "9874a7c7@f9a44da9"
...
typedef struct _cipher_params_t {
	...
	const EVP_CIPHER_CTX* cipherCtx;
}cipher_params_t;
...
unsigned char* DecryptFileProtect(char* FileIn); // _Out_bytecap_x_(_ElementSize*_Count) void * _DstBuf
...
char* GetHardwareId();
char* SmallHardwareId();
char* GetHardwareIdNow();
...
public:
	bool	InitUiState;
	bool	InitThreadState;
	bool	IsInGame;
	bool	IsActivePlayerNpc;
	bool	IsActiveMissleSame;
	bool	IsActiveVisiblePlayer;
	unsigned int KPlayer_Offset1;
	unsigned int RoleName_Offset1;
	unsigned int PlayerIndex_Offset1;
	unsigned int nPlayerIndex_Offset1;
	int m_PlayerIndex;
	int szTipLen;
	int szTipMaxtrix;
	int szTipLenCenter;
