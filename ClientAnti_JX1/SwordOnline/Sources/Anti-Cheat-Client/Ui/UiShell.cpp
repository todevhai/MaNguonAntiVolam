...
//	Player_Unlock::RegisterSelfClass();
	Player_AutoPlay::RegisterSelfClass();
	Player_Market::RegisterSelfClass();
	Player_TongKim::RegisterSelfClass();
...
bool UiCloseWndsInGame(bool bAll)
{
	if (bAll == false)
	{
		if (KUiStatus::GetIfVisible() == NULL &&
			...
			KUiExBox1::GetIfVisible() == NULL &&
			KUiExBox2::GetIfVisible() == NULL &&
			KUiExBox3::GetIfVisible() == NULL &&
			KUiItemEX::GetIfVisible() == NULL &&
	...
	KUiPK::CloseWindow();
	KUiChangeAvatar::CloseWindow(bAll);
	return true;
}
...
/*IMPLEMENT_COMCLASS(Player_Unlock)
void Player_Unlock::OnButtonClick()
{
	KUiUnlockBox::OpenWindow();
}
const char*	Player_Unlock::GetShortKey()
{
	return NULL;
}*/
...
IMPLEMENT_COMCLASS(Player_Market)
void Player_Market::OnButtonClick()
{
	KShortcutKeyCentre::ExcuteScript(SCK_SHORTCUT_MARKET);
}

const char*	Player_Market::GetShortKey()
{
	return KShortcutKeyCentre::GetKeyName(
		KShortcutKeyCentre::GetCommandKey(
		KShortcutKeyCentre::FindCommandByScript(SCK_SHORTCUT_MARKET)));
}

IMPLEMENT_COMCLASS(Player_TongKim)
void Player_TongKim::OnButtonClick()
{
	KShortcutKeyCentre::ExcuteScript(SCK_SHORTCUT_TONGKIM);
}

const char*	Player_TongKim::GetShortKey()
{
	return KShortcutKeyCentre::GetKeyName(
		KShortcutKeyCentre::GetCommandKey(
		KShortcutKeyCentre::FindCommandByScript(SCK_SHORTCUT_TONGKIM)));
}
