...
public:
    ...
    //  =======================================================================
	void Start(int resourceId, HINSTANCE hins, COLORREF colTrans, bool hShowText, char hText[255], COLORREF hTextColor, int nType);
	void Start(int resourceId, HINSTANCE hins, COLORREF colTrans);
	void Start(LPCTSTR lpszFileName, COLORREF colTrans);
	void Start(LPCTSTR lpszFileName, COLORREF colTrans, bool hShowText, char hText[255], COLORREF hTextColor, int nType);
    //  =======================================================================
    //  Func   ~CSplash
    //  Desc   Desctructor
    //  =======================================================================
...
private:
	...
	bool m_ShowText;
    TCHAR m_TextToDisplay[255];
	COLORREF m_TextColor;
	int m_SplashType;
};

extern CSplash SplashInit;
extern CSplash SplashAlert;
extern CSplash SplashError;
