...
private:
	...
	//KWndButton m_KingSoft;					//自动登陆
	//KWndButton m_ExitGame;					// 退出游戏
	//KWndButton m_EnterGameBorder;			//vien bat dau
	//KWndButton m_GameConfigBorder;			//vien cau hinh
	//KWndButton m_OpenRepBorder;				//vien xem lai hinh anh
	//KWndButton m_ExitGameBorder;			//vien thoat
