	TITLE	E:\Ma Nguon\SwordOnline\Sources\Core\Src\KMissle.cpp
	.386P
include listing.inc
if @Version gt 510
.model FLAT
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T91010	DD	019930520H
	DD	01H
	DD	FLAT:$T91012
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T91012	DD	0ffffffffH
	DD	FLAT:$L91007
xdata$x	ENDS
;	COMDAT ??1KMissleSet@@QAE@XZ
_TEXT	SEGMENT
...
;	COMDAT ??_7KMissle@@6B@
; File E:\Ma Nguon\SwordOnline\Sources\Core\Src\KMissle.cpp
CONST	SEGMENT
??_7KMissle@@6B@ DD FLAT:??_EKMissle@@UAEPAXI@Z		; KMissle::`vftable'
CONST	ENDS
xdata$x	SEGMENT
$T91028	DD	019930520H
	DD	01H
	DD	FLAT:$T91030
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T91030	DD	0ffffffffH
	DD	FLAT:$L91025
xdata$x	ENDS
_TEXT	SEGMENT
__$EHRec$ = -12
...
;	COMDAT ??_7KIndexNode@@6B@
; File E:\Ma Nguon\SwordOnline\Sources\Core\Src\KIndexNode.h
CONST	SEGMENT
...
xdata$x	SEGMENT
$T91052	DD	019930520H
	DD	01H
	DD	FLAT:$T91054
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T91054	DD	0ffffffffH
	DD	FLAT:$L91049
xdata$x	ENDS
_TEXT	SEGMENT
_this$ = -16
...
_BSS	ENDS
_DATA	SEGMENT
$SG90029 DB	'MissleName', 00H
	ORG $+1
$SG90031 DB	'MissleHeight', 00H
	ORG $+3
$SG90032 DB	'LifeTime', 00H
	ORG $+3
$SG90033 DB	'Speed', 00H
	ORG $+2
$SG90034 DB	'ResponseSkill', 00H
	ORG $+2
$SG90035 DB	'CollidRange', 00H
$SG90036 DB	'ColVanish', 00H
	ORG $+2
$SG90037 DB	'CanColFriend', 00H
	ORG $+3
$SG90038 DB	'CanSlow', 00H
$SG90039 DB	'IsRangeDmg', 00H
	ORG $+1
$SG90040 DB	'DmgRange', 00H
	ORG $+3
$SG90042 DB	'MoveKind', 00H
	ORG $+3
$SG90044 DB	'FollowKind', 00H
	ORG $+1
$SG90046 DB	'Zacc', 00H
	ORG $+3
$SG90048 DB	'Zspeed', 00H
	ORG $+1
$SG90049 DB	'Param1', 00H
	ORG $+1
$SG90050 DB	'Param2', 00H
	ORG $+1
$SG90051 DB	'Param3', 00H
	ORG $+1
$SG90054 DB	'AutoExplode', 00H
$SG90056 DB	'DmgInterval', 00H
$SG90063 DB	'RedLum', 00H
	ORG $+1
$SG90065 DB	'GreenLum', 00H
	ORG $+3
$SG90067 DB	'BlueLum', 00H
$SG90070 DB	'LightRadius', 00H
$SG90071 DB	'MultiShow', 00H
	ORG $+2
$SG90076 DB	'AnimFile%d', 00H
	ORG $+1
$SG90077 DB	'SndFile%d', 00H
	ORG $+2
$SG90078 DB	'AnimFileInfo%d', 00H
	ORG $+1
$SG90082 DB	'AnimFileB%d', 00H
$SG90083 DB	'SndFileB%d', 00H
	ORG $+1
$SG90084 DB	'AnimFileInfoB%d', 00H
$SG90088 DB	'LoopPlay', 00H
	ORG $+3
$SG90089 DB	'SubLoop', 00H
$SG90090 DB	'SubStart', 00H
	ORG $+3
$SG90091 DB	'SubStop', 00H
$SG90093 DB	'ColFollowTarget', 00H
_DATA	ENDS
_TEXT	SEGMENT
_pMisslesSetting$ = 8
_nMissleId$ = 12
...
; 200  : 	pMisslesSetting->GetString(nRow, "MissleName",		   "", m_szMissleName,30, TRUE);
	...
	push	eax
	push	OFFSET FLAT:$SG90028
	push	OFFSET FLAT:$SG90029
...
; 338  : 	if (!Npc[m_nLauncher].IsMatch(m_dwLauncherId) || Npc[m_nLauncher].m_SubWorldIndex != m_nSubWorldId || Npc[m_nLauncher].m_RegionIndex < 0)
	...
	imul	ecx, 33616				; 00008350H
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR ?Npc@@3PAVKNpc@@A[ecx+3072]
	cmp	eax, DWORD PTR [edx+364]
	jne	SHORT $L90110
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+336]
	imul	edx, 33616				; 00008350H
	cmp	DWORD PTR ?Npc@@3PAVKNpc@@A[edx+3076], 0
	jge	SHORT $L90109
$L90110:
...
; 351  : 		if (Npc[m_nFollowNpcIdx].m_SubWorldIndex != m_nSubWorldId)
	...
	imul	edx, 33616				; 00008350H
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR ?Npc@@3PAVKNpc@@A[edx+3072]
...
; 382  : 			int nSrcX2 = 0 ;
	...
	mov	DWORD PTR _nSrcX2$90118[ebp], 0

; 383  : 			int nSrcY2 = 0 ;

	mov	DWORD PTR _nSrcY2$90119[ebp], 0

; 384  : 			SubWorld[0].Map2Mps(m_nRegionId, m_nCurrentMapX, m_nCurrentMapY,m_nXOffset, m_nYOffset, &nSrcX2, &nSrcY2);

	lea	eax, DWORD PTR _nSrcY2$90119[ebp]
	push	eax
	lea	ecx, DWORD PTR _nSrcX2$90118[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
...
; 385  : 			m_MissleRes.PlaySound(MS_DoFly, nSrcX2, nSrcY2, 0);
	...
	push	0
	mov	eax, DWORD PTR _nSrcY2$90119[ebp]
	push	eax
	mov	ecx, DWORD PTR _nSrcX2$90118[ebp]
	push	ecx
	push	1
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 468				; 000001d4H
...
; 411  : 					KSkill * pOrdinSkill = (KSkill *) g_SkillManager.GetSkill(m_nSkillId , m_nLevel);
	...
	mov	DWORD PTR _pOrdinSkill$90131[ebp], eax

; 412  : 					if (pOrdinSkill)

	cmp	DWORD PTR _pOrdinSkill$90131[ebp], 0
	je	SHORT $L90133
...
; 414  : 						pOrdinSkill->FlyEvent(this);
	...
	mov	ecx, DWORD PTR _this$[ebp]
	push	ecx
	mov	ecx, DWORD PTR _pOrdinSkill$90131[ebp]
...
; 439  : 		SubWorld[0].Map2Mps(m_nRegionId, m_nCurrentMapX, m_nCurrentMapY,m_nXOffset, m_nYOffset, &nSrcX, &nSrcY);
	...
	lea	eax, DWORD PTR _nSrcY$90138[ebp]
	push	eax
	lea	ecx, DWORD PTR _nSrcX$90137[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+236]
	push	eax
...
; 441  : 			g_ScenePlace.MoveObject(CGOG_MISSLE, m_nMissleId, nSrcX, nSrcY, m_nCurrentMapZ, m_SceneID, IPOT_RL_OBJECT | IPOT_RL_LIGHT_PROP );
	...
	push	edx
	mov	eax, DWORD PTR _nSrcY$90138[ebp]
	push	eax
	mov	ecx, DWORD PTR _nSrcX$90137[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
...
; 443  : 			g_ScenePlace.MoveObject(CGOG_MISSLE, m_nMissleId, nSrcX, nSrcY, m_nCurrentMapZ, m_SceneID, IPOT_RL_OBJECT);
	...
	push	eax
	mov	ecx, DWORD PTR _nSrcY$90138[ebp]
	push	ecx
	mov	edx, DWORD PTR _nSrcX$90137[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
...
; 607  : 	BOOL				IsMatch(DWORD dwID)	{ return dwID == m_dwID; };	// 是否ID与该Index匹配
...
; 529  : 				ProcessCollision(m_nLauncher, Npc[nNpcIdx].m_RegionIndex , Npc[nNpcIdx].m_MapX, Npc[nNpcIdx].m_MapY, m_nDamageRange , m_eRelation);
	...
	imul	ecx, 33616				; 00008350H
	mov	edx, DWORD PTR ?Npc@@3PAVKNpc@@A[ecx+3552]
	push	edx
	mov	eax, DWORD PTR _nNpcIdx$[ebp]
	imul	eax, 33616				; 00008350H
	mov	ecx, DWORD PTR ?Npc@@3PAVKNpc@@A[eax+3076]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+336]
	push	eax
...
; 538  : 		for (int i = -m_nCollideRange; i <= m_nCollideRange; i ++)
	...
	neg	edx
	mov	DWORD PTR _i$90178[ebp], edx
	jmp	SHORT $L90179
$L90180:
	mov	eax, DWORD PTR _i$90178[ebp]
	add	eax, 1
	mov	DWORD PTR _i$90178[ebp], eax
$L90179:
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _i$90178[ebp]
...
; 539  : 			for (int j = -m_nCollideRange; j <= m_nCollideRange; j ++)
	...
	neg	ecx
	mov	DWORD PTR _j$90182[ebp], ecx
	jmp	SHORT $L90183
$L90184:
	mov	edx, DWORD PTR _j$90182[ebp]
	add	edx, 1
	mov	DWORD PTR _j$90182[ebp], edx
$L90183:
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _j$90182[ebp]
...
_dx$90238 = -76
_dy$90239 = -80
_nOldRegion$90242 = -84
_nPreAngle$90249 = -88
_dx$90253 = -92
_dy$90254 = -96
_nOldRegion$90257 = -100
_nDistance$90263 = -120
_nSrcMpsX$90264 = -116
_nSrcMpsY$90265 = -112
_nDesMpsX$90266 = -104
_nDesMpsY$90267 = -108
...
; 572  : 			Npc[m_nLauncher].GetMpsPos(&nPX, &nPY);
	...
	lea	edx, DWORD PTR _nPY$90198[ebp]
	push	edx
	lea	eax, DWORD PTR _nPX$90197[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 573  : 			if (nPX != m_nLauncherSrcPX || nPY != m_nLauncherSrcPY)
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _nPX$90197[ebp]
	cmp	eax, DWORD PTR [edx+140]
	jne	SHORT $L90200
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _nPY$90198[ebp]
...
; 577  : 				int nSrcX2 = 0 ;
	...
	mov	DWORD PTR _nSrcX2$90201[ebp], 0

; 578  : 				int nSrcY2 = 0 ;

	mov	DWORD PTR _nSrcY2$90202[ebp], 0

; 579  : 				SubWorld[0].Map2Mps(m_nRegionId, m_nCurrentMapX, m_nCurrentMapY,m_nXOffset, m_nYOffset, &nSrcX2, &nSrcY2);

	lea	eax, DWORD PTR _nSrcY2$90202[ebp]
	push	eax
	lea	ecx, DWORD PTR _nSrcX2$90201[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+236]
	push	eax
...
; 580  : 				CreateSpecialEffect(MS_DoVanish, nSrcX2, nSrcY2, m_nCurrentMapZ);
	...
	push	ecx
	mov	edx, DWORD PTR _nSrcY2$90202[ebp]
	push	edx
	mov	eax, DWORD PTR _nSrcX2$90201[ebp]
	push	eax
	push	2
	mov	ecx, DWORD PTR _this$[ebp]
...
; 593  : 		int nSrcX3 = 0 ;
	...
	mov	DWORD PTR _nSrcX3$90204[ebp], 0

; 594  : 		int nSrcY3 = 0 ;

	mov	DWORD PTR _nSrcY3$90205[ebp], 0

; 595  : 		SubWorld[0].Map2Mps(m_nRegionId, m_nCurrentMapX, m_nCurrentMapY,m_nXOffset, m_nYOffset, &nSrcX3, &nSrcY3);

	lea	ecx, DWORD PTR _nSrcY3$90205[ebp]
	push	ecx
	lea	edx, DWORD PTR _nSrcX3$90204[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
...
; 596  : 		CreateSpecialEffect(MS_DoVanish, nSrcX3, nSrcY3, m_nCurrentMapZ);
	...
	mov	edx, DWORD PTR [ecx+228]
	push	edx
	mov	eax, DWORD PTR _nSrcY3$90205[ebp]
	push	eax
	mov	ecx, DWORD PTR _nSrcX3$90204[ebp]
	push	ecx
	push	2
	mov	ecx, DWORD PTR _this$[ebp]
	call	?CreateSpecialEffect@KMissle@@QAEHW4eMissleStatus@@HHHH@Z ; KMissle::CreateSpecialEffect
...
; 607  : 	{
	...
	xor	edx, edx
	mov	dl, BYTE PTR $L91077[eax]
	jmp	DWORD PTR $L91078[edx*4]
$L90213:
...
; 621  : 					int nDistance = 0;
	...
	mov	DWORD PTR _nDistance$90216[ebp], 0

; 622  : 					int nSrcMpsX = 0;

	mov	DWORD PTR _nSrcMpsX$90217[ebp], 0

; 623  : 					int nSrcMpsY = 0;

	mov	DWORD PTR _nSrcMpsY$90218[ebp], 0

; 624  : 					int nDesMpsX = 0;

	mov	DWORD PTR _nDesMpsX$90219[ebp], 0

; 625  : 					int nDesMpsY = 0;

	mov	DWORD PTR _nDesMpsY$90220[ebp], 0

; 626  : 					
; 627  : 					GetMpsPos(&nSrcMpsX,&nSrcMpsY);

	lea	ecx, DWORD PTR _nSrcMpsY$90218[ebp]
	push	ecx
	lea	edx, DWORD PTR _nSrcMpsX$90217[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
...
; 628  : 					Npc[m_nFollowNpcIdx].GetMpsPos(&nDesMpsX,&nDesMpsY);
	...
	lea	eax, DWORD PTR _nDesMpsY$90220[ebp]
	push	eax
	lea	ecx, DWORD PTR _nDesMpsX$90219[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
...
; 629  : 					nDistance = SubWorld[m_nSubWorldId].GetDistance(nSrcMpsX,nSrcMpsY,nDesMpsX,nDesMpsY);
	...
	mov	eax, DWORD PTR _nDesMpsY$90220[ebp]
	push	eax
	mov	ecx, DWORD PTR _nDesMpsX$90219[ebp]
	push	ecx
	mov	edx, DWORD PTR _nSrcMpsY$90218[ebp]
	push	edx
	mov	eax, DWORD PTR _nSrcMpsX$90217[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	...
	mov	DWORD PTR _nDistance$90216[ebp], eax

; 630  : 					if (nDistance > 20)

	cmp	DWORD PTR _nDistance$90216[ebp], 20	; 00000014H
	jle	$L90221

; 632  : 						int nXFactor = ((nDesMpsX - nSrcMpsX) << 10)/nDistance;

	mov	eax, DWORD PTR _nDesMpsX$90219[ebp]
	sub	eax, DWORD PTR _nSrcMpsX$90217[ebp]
	shl	eax, 10					; 0000000aH
	cdq
	idiv	DWORD PTR _nDistance$90216[ebp]
	mov	DWORD PTR _nXFactor$90222[ebp], eax

; 633  : 						int nYFactor = ((nDesMpsY - nSrcMpsY) << 10)/nDistance;

	mov	eax, DWORD PTR _nDesMpsY$90220[ebp]
	sub	eax, DWORD PTR _nSrcMpsY$90218[ebp]
	shl	eax, 10					; 0000000aH
	cdq
	idiv	DWORD PTR _nDistance$90216[ebp]
	mov	DWORD PTR _nYFactor$90223[ebp], eax

; 634  : 						int dx = nXFactor * m_nSpeed / 1.3;

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _nXFactor$90222[ebp]
	imul	eax, DWORD PTR [edx+100]
	mov	DWORD PTR -172+[ebp], eax
	fild	DWORD PTR -172+[ebp]
	fdiv	QWORD PTR __real@8@3fffa666666666666800
	call	__ftol
	mov	DWORD PTR _dx$90224[ebp], eax

; 635  : 						int dy = nYFactor * m_nSpeed / 1.3;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _nYFactor$90223[ebp]
	imul	edx, DWORD PTR [ecx+100]
	mov	DWORD PTR -176+[ebp], edx
	fild	DWORD PTR -176+[ebp]
	fdiv	QWORD PTR __real@8@3fffa666666666666800
	call	__ftol
	mov	DWORD PTR _dy$90225[ebp], eax

; 636  : 						nDOffsetX = dx;

	mov	eax, DWORD PTR _dx$90224[ebp]
	mov	DWORD PTR _nDOffsetX$[ebp], eax

; 637  : 						nDOffsetY = dy;

	mov	ecx, DWORD PTR _dy$90225[ebp]
	mov	DWORD PTR _nDOffsetY$[ebp], ecx

; 638  : 						m_nDir = g_GetDirIndex(nSrcMpsX,nSrcMpsY,nDesMpsX,nDesMpsY);

	mov	edx, DWORD PTR _nDesMpsY$90220[ebp]
	push	edx
	mov	eax, DWORD PTR _nDesMpsX$90219[ebp]
	push	eax
	mov	ecx, DWORD PTR _nSrcMpsY$90218[ebp]
	push	ecx
	mov	edx, DWORD PTR _nSrcMpsX$90217[ebp]
	push	edx
...
; 687  : 			int nPreAngle = m_nAngle - 1;
	...
	sub	edx, 1
	mov	DWORD PTR _nPreAngle$90235[ebp], edx

; 688  : 			if (nPreAngle < 0) nPreAngle = MaxMissleDir - 1;

	cmp	DWORD PTR _nPreAngle$90235[ebp], 0
	jge	SHORT $L90236
	mov	DWORD PTR _nPreAngle$90235[ebp], 63	; 0000003fH
$L90236:
...
; 691  : 			int dx = (m_nSpeed + 250)  * (g_DirCos(m_nAngle,MaxMissleDir) - g_DirCos(nPreAngle,MaxMissleDir)) ;
	...
	mov	edi, eax
	push	64					; 00000040H
	mov	ecx, DWORD PTR _nPreAngle$90235[ebp]
	push	ecx
	call	?g_DirCos@@YAHHH@Z			; g_DirCos
	add	esp, 8
	sub	edi, eax
	imul	esi, edi
	mov	DWORD PTR _dx$90238[ebp], esi
...
; 692  : 			int dy = (m_nSpeed + 50)  * (g_DirSin(m_nAngle,MaxMissleDir) - g_DirSin(nPreAngle, MaxMissleDir)) ; 
	...
	mov	edi, eax
	push	64					; 00000040H
	mov	edx, DWORD PTR _nPreAngle$90235[ebp]
	push	edx
	call	?g_DirSin@@YAHHH@Z			; g_DirSin
	add	esp, 8
	sub	edi, eax
	imul	esi, edi
	mov	DWORD PTR _dy$90239[ebp], esi
...
; 696  : 				nDOffsetX = dx;
	...
	mov	ecx, DWORD PTR _dx$90238[ebp]
	mov	DWORD PTR _nDOffsetX$[ebp], ecx

; 697  : 				nDOffsetY = dy;

	mov	edx, DWORD PTR _dy$90239[ebp]
...
; 701  : 				int nOldRegion = m_nRegionId;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+368]
	mov	DWORD PTR _nOldRegion$90242[ebp], ecx
...
; 703  : 				m_nRegionId		= Npc[m_nLauncher].m_RegionIndex;
	...
	imul	edx, 33616				; 00008350H
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR ?Npc@@3PAVKNpc@@A[edx+3076]
...
; 704  : 				m_nCurrentMapX	= Npc[m_nLauncher].m_MapX;
	...
	imul	eax, 33616				; 00008350H
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR ?Npc@@3PAVKNpc@@A[eax+3552]
...
; 705  : 				m_nCurrentMapY	= Npc[m_nLauncher].m_MapY;
	...
	imul	ecx, 33616				; 00008350H
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR ?Npc@@3PAVKNpc@@A[ecx+3556]
...
; 706  : 				m_nXOffset		= Npc[m_nLauncher].m_OffX;
	...
	imul	edx, 33616				; 00008350H
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR ?Npc@@3PAVKNpc@@A[edx+3564]
...
; 707  : 				m_nYOffset		= Npc[m_nLauncher].m_OffY;
	...
	imul	eax, 33616				; 00008350H
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR ?Npc@@3PAVKNpc@@A[eax+3568]
...
; 710  : 				if (nOldRegion != m_nRegionId)
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _nOldRegion$90242[ebp]
...
; 712  : 					SubWorld[m_nSubWorldId].m_WorldMessage.Send(GWM_MISSLE_CHANGE_REGION, nOldRegion, m_nRegionId, m_nMissleId);
	...
	mov	edx, DWORD PTR [ecx+368]
	push	edx
	mov	eax, DWORD PTR _nOldRegion$90242[ebp]
	push	eax
	push	4002					; 00000fa2H
	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+364]
...
; 714  : 				nDOffsetX = dx;
	...
	mov	edx, DWORD PTR _dx$90238[ebp]
	mov	DWORD PTR _nDOffsetX$[ebp], edx

; 715  : 				nDOffsetY = dy;

	mov	eax, DWORD PTR _dy$90239[ebp]
	mov	DWORD PTR _nDOffsetY$[ebp], eax
$L90241:
...
; 753  : 				m_nAngle = Npc[m_nLauncher].m_Dir;
	...
	imul	eax, 33616				; 00008350H
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR ?Npc@@3PAVKNpc@@A[eax+3536]
...
; 762  : 				nPreAngle = m_nAngle + 1;
	...
	mov	edx, DWORD PTR [ecx+432]
	add	edx, 1
	mov	DWORD PTR _nPreAngle$90249[ebp], edx
...
; 769  : 			if (nPreAngle > MaxMissleDir)
	...
	cmp	DWORD PTR _nPreAngle$90249[ebp], 64	; 00000040H
	jle	SHORT $L90251

; 771  : 				nPreAngle = 0;

	mov	DWORD PTR _nPreAngle$90249[ebp], 0
$L90251:
...
; 778  : 			int dx = (m_nSpeed + m_nCurrentLife + 275)  * (g_DirCos(m_nAngle,MaxMissleDir) - g_DirCos(nPreAngle, MaxMissleDir)) ;
	...
	mov	edi, eax
	push	64					; 00000040H
	mov	ecx, DWORD PTR _nPreAngle$90249[ebp]
	push	ecx
	call	?g_DirCos@@YAHHH@Z			; g_DirCos
	add	esp, 8
	sub	edi, eax
	imul	esi, edi
	mov	DWORD PTR _dx$90253[ebp], esi
...
; 779  : 			int dy = (m_nSpeed + m_nCurrentLife + 275)  * (g_DirSin(m_nAngle,MaxMissleDir) - g_DirSin(nPreAngle,MaxMissleDir)) ; 
	...
	mov	edi, eax
	push	64					; 00000040H
	mov	edx, DWORD PTR _nPreAngle$90249[ebp]
	push	edx
	call	?g_DirSin@@YAHHH@Z			; g_DirSin
	add	esp, 8
	sub	edi, eax
	imul	esi, edi
	mov	DWORD PTR _dy$90254[ebp], esi
...
; 784  : 				nDOffsetX = dx;
	...
	mov	ecx, DWORD PTR _dx$90253[ebp]
	mov	DWORD PTR _nDOffsetX$[ebp], ecx

; 785  : 				nDOffsetY = dy;

	mov	edx, DWORD PTR _dy$90254[ebp]
	mov	DWORD PTR _nDOffsetY$[ebp], edx
...
; 789  : 				int nOldRegion = m_nRegionId;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+368]
	mov	DWORD PTR _nOldRegion$90257[ebp], ecx
...
; 794  : 				m_nXOffset		= Npc[m_nLauncher].m_OffX + (35 * g_DirCos(Npc[m_nLauncher].m_Dir,64) + 100);
	...
	imul	esi, 33616				; 00008350H
	push	64					; 00000040H
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+336]
	imul	eax, 33616				; 00008350H
	mov	ecx, DWORD PTR ?Npc@@3PAVKNpc@@A[eax+3536]
	push	ecx
	call	?g_DirCos@@YAHHH@Z			; g_DirCos
	add	esp, 8
	imul	eax, 35					; 00000023H
	mov	edx, DWORD PTR ?Npc@@3PAVKNpc@@A[esi+3564]
...
; 795  : 				m_nYOffset		= Npc[m_nLauncher].m_OffY + (35 * g_DirSin(Npc[m_nLauncher].m_Dir,64) + 100);
	...
	mov	ecx, DWORD PTR [eax+336]
	imul	ecx, 33616				; 00008350H
	mov	edx, DWORD PTR ?Npc@@3PAVKNpc@@A[ecx+3536]
	push	edx
	call	?g_DirSin@@YAHHH@Z			; g_DirSin
	add	esp, 8
	imul	eax, 35					; 00000023H
	mov	ecx, DWORD PTR ?Npc@@3PAVKNpc@@A[esi+3568]
...
; 798  : 				if (nOldRegion != m_nRegionId)
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _nOldRegion$90257[ebp]
	cmp	ecx, DWORD PTR [eax+368]
	je	SHORT $L90258
...
; 800  : 					SubWorld[m_nSubWorldId].m_WorldMessage.Send(GWM_MISSLE_CHANGE_REGION, nOldRegion, m_nRegionId, m_nMissleId);
	...
	mov	edx, DWORD PTR [ecx+368]
	push	edx
	mov	eax, DWORD PTR _nOldRegion$90257[ebp]
	push	eax
	push	4002					; 00000fa2H
	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+364]
...
; 802  : 				nDOffsetX = dx;
	...
	mov	edx, DWORD PTR _dx$90253[ebp]
	mov	DWORD PTR _nDOffsetX$[ebp], edx

; 803  : 				nDOffsetY = dy;

	mov	eax, DWORD PTR _dy$90254[ebp]
	mov	DWORD PTR _nDOffsetY$[ebp], eax
$L90256:
...
; 827  : 					int nDistance = 0;
	...
	mov	DWORD PTR _nDistance$90263[ebp], 0

; 828  : 					int nSrcMpsX = 0;

	mov	DWORD PTR _nSrcMpsX$90264[ebp], 0

; 829  : 					int nSrcMpsY = 0;

	mov	DWORD PTR _nSrcMpsY$90265[ebp], 0

; 830  : 					int nDesMpsX = 0;

	mov	DWORD PTR _nDesMpsX$90266[ebp], 0

; 831  : 					int nDesMpsY = 0;

	mov	DWORD PTR _nDesMpsY$90267[ebp], 0

; 832  : 					
; 833  : 					GetMpsPos(&nSrcMpsX,&nSrcMpsY);

	lea	edx, DWORD PTR _nSrcMpsY$90265[ebp]
	push	edx
	lea	eax, DWORD PTR _nSrcMpsX$90264[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetMpsPos@KMissle@@QAEXPAH0@Z		; KMissle::GetMpsPos
...
; 834  : 					Npc[m_nFollowNpcIdx].GetMpsPos(&nDesMpsX,&nDesMpsY);
	...
	lea	ecx, DWORD PTR _nDesMpsY$90267[ebp]
	push	ecx
	lea	edx, DWORD PTR _nDesMpsX$90266[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
...
; 835  : 					nDistance = SubWorld[m_nSubWorldId].GetDistance(nSrcMpsX,nSrcMpsY,nDesMpsX,nDesMpsY);
	...
	mov	ecx, DWORD PTR _nDesMpsY$90267[ebp]
	push	ecx
	mov	edx, DWORD PTR _nDesMpsX$90266[ebp]
	push	edx
	mov	eax, DWORD PTR _nSrcMpsY$90265[ebp]
	push	eax
	mov	ecx, DWORD PTR _nSrcMpsX$90264[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	...
	add	ecx, OFFSET FLAT:?SubWorld@@3PAVKSubWorld@@A
	call	?GetDistance@KSubWorld@@QAEHHHHH@Z	; KSubWorld::GetDistance
	mov	DWORD PTR _nDistance$90263[ebp], eax

; 836  : 					if (nDistance > 20)

	cmp	DWORD PTR _nDistance$90263[ebp], 20	; 00000014H
	jle	$L90268

; 838  : 						int nXFactor = ((nDesMpsX - nSrcMpsX) << 10)/nDistance;

	mov	eax, DWORD PTR _nDesMpsX$90266[ebp]
	sub	eax, DWORD PTR _nSrcMpsX$90264[ebp]
	shl	eax, 10					; 0000000aH
	cdq
	idiv	DWORD PTR _nDistance$90263[ebp]
	mov	DWORD PTR _nXFactor$90269[ebp], eax

; 839  : 						int nYFactor = ((nDesMpsY - nSrcMpsY) << 10)/nDistance;

	mov	eax, DWORD PTR _nDesMpsY$90267[ebp]
	sub	eax, DWORD PTR _nSrcMpsY$90265[ebp]
	shl	eax, 10					; 0000000aH
	cdq
	idiv	DWORD PTR _nDistance$90263[ebp]
	mov	DWORD PTR _nYFactor$90270[ebp], eax

; 840  : 						int dx = nXFactor * m_nSpeed / 1.3;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _nXFactor$90269[ebp]
	imul	ecx, DWORD PTR [eax+100]
	mov	DWORD PTR -180+[ebp], ecx
	fild	DWORD PTR -180+[ebp]
	fdiv	QWORD PTR __real@8@3fffa666666666666800
	call	__ftol
	mov	DWORD PTR _dx$90271[ebp], eax

; 841  : 						int dy = nYFactor * m_nSpeed / 1.3;

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _nYFactor$90270[ebp]
	imul	eax, DWORD PTR [edx+100]
	mov	DWORD PTR -184+[ebp], eax
	fild	DWORD PTR -184+[ebp]
	fdiv	QWORD PTR __real@8@3fffa666666666666800
	call	__ftol
	mov	DWORD PTR _dy$90272[ebp], eax

; 842  : 						nDOffsetX = dx;

	mov	ecx, DWORD PTR _dx$90271[ebp]
	mov	DWORD PTR _nDOffsetX$[ebp], ecx

; 843  : 						nDOffsetY = dy;

	mov	edx, DWORD PTR _dy$90272[ebp]
	mov	DWORD PTR _nDOffsetY$[ebp], edx
...
; 844  : 						m_nDir = g_GetDirIndex(nSrcMpsX,nSrcMpsY,nDesMpsX,nDesMpsY);
	...
	mov	eax, DWORD PTR _nDesMpsY$90267[ebp]
	push	eax
	mov	ecx, DWORD PTR _nDesMpsX$90266[ebp]
	push	ecx
	mov	edx, DWORD PTR _nSrcMpsY$90265[ebp]
	push	edx
	mov	eax, DWORD PTR _nSrcMpsX$90264[ebp]
	push	eax
	call	?g_GetDirIndex@@YAHHHHH@Z		; g_GetDirIndex
	add	esp, 16					; 00000010H
	mov	ecx, DWORD PTR _this$[ebp]
...
; 876  : 			int x = m_nXOffset;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+232]
	mov	DWORD PTR _x$90278[ebp], edx

; 877  : 			int y = m_nYOffset;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+236]
	mov	DWORD PTR _y$90279[ebp], ecx
...
; 878  : 			int dx = (m_nSpeed * m_nXFactor);
	...
	mov	DWORD PTR _dx$90280[ebp], ecx
...
; 879  : 			int dy = (m_nSpeed * m_nYFactor);
	...
	mov	DWORD PTR _dy$90281[ebp], ecx

; 880  : 			nDOffsetX	=  dx;//* m_nCurrentLife;

	mov	edx, DWORD PTR _dx$90280[ebp]
	mov	DWORD PTR _nDOffsetX$[ebp], edx

; 881  : 			nDOffsetY	=  dy;//* m_nCurrentLife;

	mov	eax, DWORD PTR _dy$90281[ebp]
	mov	DWORD PTR _nDOffsetY$[ebp], eax
$L90282:
$L90209:
...
; 901  : 			int nSrcX4 = 0 ;
	...
	mov	DWORD PTR _nSrcX4$90287[ebp], 0

; 902  : 			int nSrcY4 = 0 ;

	mov	DWORD PTR _nSrcY4$90288[ebp], 0

; 903  : 			SubWorld[0].Map2Mps(m_nRegionId, m_nCurrentMapX, m_nCurrentMapY,m_nXOffset, m_nYOffset, &nSrcX4, &nSrcY4);

	lea	ecx, DWORD PTR _nSrcY4$90288[ebp]
	push	ecx
	lea	edx, DWORD PTR _nSrcX4$90287[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+236]
	push	ecx
...
; 904  : 			CreateSpecialEffect(MS_DoVanish, nSrcX4, nSrcY4, m_nCurrentMapZ);
	...
	mov	edx, DWORD PTR [ecx+228]
	push	edx
	mov	eax, DWORD PTR _nSrcY4$90288[ebp]
	push	eax
	mov	ecx, DWORD PTR _nSrcX4$90287[ebp]
	push	ecx
	push	2
	mov	ecx, DWORD PTR _this$[ebp]
	call	?CreateSpecialEffect@KMissle@@QAEHW4eMissleStatus@@HHHH@Z ; KMissle::CreateSpecialEffect
...
;	COMDAT xdata$x
; File E:\Ma Nguon\SwordOnline\Sources\Core\Src\KWorldMsg.h
xdata$x	SEGMENT
$T91087	DD	019930520H
	DD	01H
	DD	FLAT:$T91089
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T91089	DD	0ffffffffH
	DD	FLAT:$L91085
xdata$x	ENDS
;	COMDAT ?Send@KWorldMsg@@QAEHKHHH@Z
_TEXT	SEGMENT
...
; 74   : 	pNode = new KWorldMsgNode;
	...
	add	esp, 4
	mov	DWORD PTR $T91082[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T91082[ebp], 0
	je	SHORT $L91083
	mov	ecx, DWORD PTR $T91082[ebp]
...
$L91084:
	...
	mov	DWORD PTR $T91081[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T91081[ebp]
...
text$x	SEGMENT
$L91085:
	mov	eax, DWORD PTR $T91082[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
$L91088:
	mov	eax, OFFSET FLAT:$T91087
	jmp	___CxxFrameHandler
text$x	ENDS
...
; 941  : 		int nDirIndex = g_GetDirIndex(0,0,m_nXFactor, m_nYFactor);
	...
	call	?g_GetDirIndex@@YAHHHHH@Z		; g_GetDirIndex
	add	esp, 16					; 00000010H
	mov	DWORD PTR _nDirIndex$90301[ebp], eax

; 942  : 		int nDir = g_DirIndex2Dir(nDirIndex, 64);

	push	64					; 00000040H
	mov	edx, DWORD PTR _nDirIndex$90301[ebp]
	push	edx
	call	?g_DirIndex2Dir@@YAHHH@Z		; g_DirIndex2Dir
	add	esp, 8
	mov	DWORD PTR _nDir$90302[ebp], eax
...
; 943  : 		m_MissleRes.Draw(m_eMissleStatus, nSrcX, nSrcY, m_nCurrentMapZ, nDir,m_nLifeTime - m_nStartLifeTime,  m_nCurrentLife - m_nStartLifeTime );
	...
	sub	edx, DWORD PTR [ecx+212]
	push	edx
	mov	eax, DWORD PTR _nDir$90302[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+228]
	push	edx
...
; 1180 : 		KSkill * pOrdinSkill = (KSkill *) g_SkillManager.GetSkill(m_nSkillId,m_nLevel);
	...
	mov	ecx, OFFSET FLAT:?g_SkillManager@@3VKSkillManager@@A
	call	?GetSkill@KSkillManager@@QAEPAVISkill@@HH@Z ; KSkillManager::GetSkill
	mov	DWORD PTR _pOrdinSkill$90363[ebp], eax

; 1181 : 		if (pOrdinSkill)

	cmp	DWORD PTR _pOrdinSkill$90363[ebp], 0
	je	SHORT $L90365
...
; 1183 : 			pOrdinSkill->Vanish(this);
	...
	mov	ecx, DWORD PTR _this$[ebp]
	push	ecx
	mov	ecx, DWORD PTR _pOrdinSkill$90363[ebp]
...
; 1215 : 		KSkill * pOrdinSkill = (KSkill *)g_SkillManager.GetSkill(m_nSkillId, m_nLevel);
	...
	mov	ecx, OFFSET FLAT:?g_SkillManager@@3VKSkillManager@@A
	call	?GetSkill@KSkillManager@@QAEPAVISkill@@HH@Z ; KSkillManager::GetSkill
	mov	DWORD PTR _pOrdinSkill$90376[ebp], eax

; 1216 : 		if (pOrdinSkill)

	cmp	DWORD PTR _pOrdinSkill$90376[ebp], 0
	je	SHORT $L90378
...
; 1218 : 			pOrdinSkill->Collidsion(this);
	...
	mov	eax, DWORD PTR _this$[ebp]
	push	eax
	mov	ecx, DWORD PTR _pOrdinSkill$90376[ebp]
...
; 1229 : 		int nSrcX5 = 0 ;
	...
	mov	DWORD PTR _nSrcX5$90380[ebp], 0

; 1230 : 		int nSrcY5 = 0 ;

	mov	DWORD PTR _nSrcY5$90381[ebp], 0

; 1231 : 		SubWorld[0].Map2Mps(m_nRegionId, m_nCurrentMapX, m_nCurrentMapY,m_nXOffset, m_nYOffset, &nSrcX5, &nSrcY5);

	lea	eax, DWORD PTR _nSrcY5$90381[ebp]
	push	eax
	lea	ecx, DWORD PTR _nSrcX5$90380[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+236]
	push	eax
...
; 1232 : 		CreateSpecialEffect(MS_DoVanish, nSrcX5, nSrcY5, m_nCurrentMapZ);
	...
	mov	ecx, DWORD PTR [eax+228]
	push	ecx
	mov	edx, DWORD PTR _nSrcY5$90381[ebp]
	push	edx
	mov	eax, DWORD PTR _nSrcX5$90380[ebp]
	push	eax
	push	2
	mov	ecx, DWORD PTR _this$[ebp]
	call	?CreateSpecialEffect@KMissle@@QAEHW4eMissleStatus@@HHHH@Z ; KMissle::CreateSpecialEffect
...
; 1337 : 	int	nSubWorld = Npc[nLauncherIdx].m_SubWorldIndex;
	...
	imul	ecx, 33616				; 00008350H
	mov	edx, DWORD PTR ?Npc@@3PAVKNpc@@A[ecx+3072]
...
; 1349 : 		for (int j = -nRangeY; j <= nRangeY; j++)
	...
	neg	ecx
	mov	DWORD PTR _j$90434[ebp], ecx
	jmp	SHORT $L90435
$L90436:
	mov	edx, DWORD PTR _j$90434[ebp]
	add	edx, 1
	mov	DWORD PTR _j$90434[ebp], edx
$L90435:
	mov	eax, DWORD PTR _j$90434[ebp]
...
; 1355 : 			if (!GetOffsetAxis(nSubWorld, nRegionId, nMapX, nMapY, i , j , nSearchRegion, nRMx, nRMy))
	...
	push	eax
	mov	ecx, DWORD PTR _j$90434[ebp]
	push	ecx
	mov	edx, DWORD PTR _i$[ebp]
	push	edx
...
; 1361 : 			int nNpcIdx = SubWorld[nSubWorld].m_Region[nSearchRegion].FindNpc(nRMx, nRMy, nLauncherIdx, eRelation);
	...
	add	ecx, eax
	call	?FindNpc@KRegion@@QAEHHHHH@Z		; KRegion::FindNpc
	mov	DWORD PTR _nNpcIdx$90440[ebp], eax

; 1362 : 			if (nNpcIdx > 0)	

	cmp	DWORD PTR _nNpcIdx$90440[ebp], 0
	jle	$L90445
...
; 1366 : 				int nSrcX = 0;
	...
	mov	DWORD PTR _nSrcX$90442[ebp], 0

; 1367 : 				int nSrcY = 0;

	mov	DWORD PTR _nSrcY$90443[ebp], 0
...
; 1368 : 				SubWorld[0].Map2Mps(nSearchRegion, Npc[nNpcIdx].m_MapX,Npc[nNpcIdx].m_MapY, Npc[nNpcIdx].m_OffX, Npc[nNpcIdx].m_OffY,  &nSrcX, &nSrcY);
	...
	lea	edx, DWORD PTR _nSrcY$90443[ebp]
	push	edx
	lea	eax, DWORD PTR _nSrcX$90442[ebp]
	push	eax
	mov	ecx, DWORD PTR _nNpcIdx$90440[ebp]
	imul	ecx, 33616				; 00008350H
	mov	edx, DWORD PTR ?Npc@@3PAVKNpc@@A[ecx+3568]
	push	edx
	mov	eax, DWORD PTR _nNpcIdx$90440[ebp]
	imul	eax, 33616				; 00008350H
	mov	ecx, DWORD PTR ?Npc@@3PAVKNpc@@A[eax+3564]
	push	ecx
	mov	edx, DWORD PTR _nNpcIdx$90440[ebp]
	imul	edx, 33616				; 00008350H
	mov	eax, DWORD PTR ?Npc@@3PAVKNpc@@A[edx+3556]
	push	eax
	mov	ecx, DWORD PTR _nNpcIdx$90440[ebp]
...
; 1371 : 					CreateSpecialEffect(MS_DoCollision, nSrcX, nSrcY, m_nCurrentMapZ, nNpcIdx);
	...
	mov	ecx, DWORD PTR [eax+228]
	push	ecx
	mov	edx, DWORD PTR _nSrcY$90443[ebp]
	push	edx
	mov	eax, DWORD PTR _nSrcX$90442[ebp]
	push	eax
	push	3
	mov	ecx, DWORD PTR _this$[ebp]
	call	?CreateSpecialEffect@KMissle@@QAEHW4eMissleStatus@@HHHH@Z ; KMissle::CreateSpecialEffect
...
; 1373 : 					CreateSpecialEffect(MS_DoCollision, nSrcX, nSrcY, m_nCurrentMapZ);
	...
	mov	edx, DWORD PTR [ecx+228]
	push	edx
	mov	eax, DWORD PTR _nSrcY$90443[ebp]
	push	eax
	mov	ecx, DWORD PTR _nSrcX$90442[ebp]
	push	ecx
	push	3
	mov	ecx, DWORD PTR _this$[ebp]
	call	?CreateSpecialEffect@KMissle@@QAEHW4eMissleStatus@@HHHH@Z ; KMissle::CreateSpecialEffect
...
xdata$x	SEGMENT
$T91144	DD	019930520H
	DD	02H
	DD	FLAT:$T91146
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T91146	DD	0ffffffffH
	DD	FLAT:$L91141
	DD	0ffffffffH
	DD	FLAT:$L91142
xdata$x	ENDS
...
; 1412 : 	pNode = new KSkillSpecialNode;
	...
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T91134[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T91134[ebp], 0
	je	SHORT $L91135
	mov	ecx, DWORD PTR $T91134[ebp]
...
$L91136:
	...
	mov	DWORD PTR $T91133[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T91133[ebp]
...
; 1413 : 	KSkillSpecial * pSkillSpecial = new KSkillSpecial;
	...
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T91138[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 1
	cmp	DWORD PTR $T91138[ebp], 0
	je	SHORT $L91139
	mov	ecx, DWORD PTR $T91138[ebp]
...
$L91140:
	...
	mov	DWORD PTR $T91137[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T91137[ebp]
...
text$x	SEGMENT
$L91141:
	mov	eax, DWORD PTR $T91134[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
$L91142:
	mov	eax, DWORD PTR $T91138[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
$L91145:
	mov	eax, OFFSET FLAT:$T91144
	jmp	___CxxFrameHandler
text$x	ENDS
...
;	COMDAT ??_7KSkillSpecialNode@@6B@
; File E:\Ma Nguon\SwordOnline\Sources\Core\Src\KSkillSpecial.h
CONST	SEGMENT
...
; 57   : 	~KSkillSpecialNode(){delete m_pSkillSpecial;};
	...
	mov	DWORD PTR $T91153[ebp], edx
	mov	eax, DWORD PTR $T91153[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	add	esp, 4
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1530 : 		Npc[m_nLauncher].GetMpsPos(&nPX, &nPY);
	...
	lea	edx, DWORD PTR _nPY$90515[ebp]
	push	edx
	lea	eax, DWORD PTR _nPX$90514[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+336]
	imul	ecx, 33616				; 00008350H
...
; 1531 : 		if (nPX != m_nLauncherSrcPX || nPY != m_nLauncherSrcPY)
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _nPX$90514[ebp]
	cmp	eax, DWORD PTR [edx+140]
	jne	SHORT $L90517
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _nPY$90515[ebp]
	cmp	edx, DWORD PTR [ecx+144]
	je	SHORT $L90516
$L90517:
...
; 1540 : 		int nNewPX = 0;
	...
	mov	DWORD PTR _nNewPX$90519[ebp], 0

; 1541 : 		int nNewPY = 0;

	mov	DWORD PTR _nNewPY$90520[ebp], 0
...
; 1553 : 				Missle[m_nParentMissleIndex].GetMpsPos(&nParentPX, &nParentPY);
	...
	lea	eax, DWORD PTR _nParentPY$90525[ebp]
	push	eax
	lea	ecx, DWORD PTR _nParentPX$90524[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
...
; 1554 : 				GetMpsPos(&nSrcPX, &nSrcPY);
	...
	lea	eax, DWORD PTR _nSrcPY$90527[ebp]
	push	eax
	lea	ecx, DWORD PTR _nSrcPX$90526[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetMpsPos@KMissle@@QAEXPAH0@Z		; KMissle::GetMpsPos
...
; 1555 : 				nNewPX = nSrcPX + (nParentPX - m_nRefPX);
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _nParentPX$90524[ebp]
	sub	eax, DWORD PTR [edx+240]
	mov	ecx, DWORD PTR _nSrcPX$90526[ebp]
	add	ecx, eax
	mov	DWORD PTR _nNewPX$90519[ebp], ecx

; 1556 : 				nNewPY = nSrcPY + (nParentPY - m_nRefPY);

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _nParentPY$90525[ebp]
	sub	eax, DWORD PTR [edx+244]
	mov	ecx, DWORD PTR _nSrcPY$90527[ebp]
	add	ecx, eax
	mov	DWORD PTR _nNewPY$90520[ebp], ecx
...
; 1566 : 			Npc[m_nLauncher].GetMpsPos(&nParentPX, &nParentPY);
	...
	lea	edx, DWORD PTR _nParentPY$90531[ebp]
	push	edx
	lea	eax, DWORD PTR _nParentPX$90530[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+336]
	imul	ecx, 33616				; 00008350H
...
; 1567 : 			GetMpsPos(&nSrcPX, &nSrcPY);
	...
	lea	edx, DWORD PTR _nSrcPY$90533[ebp]
	push	edx
	lea	eax, DWORD PTR _nSrcPX$90532[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetMpsPos@KMissle@@QAEXPAH0@Z		; KMissle::GetMpsPos
...
; 1569 : 			nNewPX = nSrcPX + (nParentPX - m_nRefPX);
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _nParentPX$90530[ebp]
	sub	edx, DWORD PTR [ecx+240]
	mov	eax, DWORD PTR _nSrcPX$90532[ebp]
	add	eax, edx
	mov	DWORD PTR _nNewPX$90519[ebp], eax

; 1570 : 			nNewPY = nSrcPY + (nParentPY - m_nRefPY);

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _nParentPY$90531[ebp]
	sub	edx, DWORD PTR [ecx+244]
	mov	eax, DWORD PTR _nSrcPY$90533[ebp]
	add	eax, edx
	mov	DWORD PTR _nNewPY$90520[ebp], eax
$L90528:
...
; 1573 : 		int nOldRegion = m_nRegionId;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+368]
	mov	DWORD PTR _nOldRegion$90534[ebp], edx
...
; 1575 : 		SubWorld[m_nSubWorldId].Mps2Map(nNewPX, nNewPY, &m_nRegionId, &m_nCurrentMapX, &m_nCurrentMapY, &m_nXOffset, &m_nYOffset);
	...
	push	ecx
	mov	edx, DWORD PTR _nNewPY$90520[ebp]
	push	edx
	mov	eax, DWORD PTR _nNewPX$90519[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+364]
	imul	ecx, 220				; 000000dcH
...
; 1578 : 		if (nOldRegion != m_nRegionId)
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _nOldRegion$90534[ebp]
...
; 1580 : 			SubWorld[m_nSubWorldId].m_WorldMessage.Send(GWM_MISSLE_CHANGE_REGION, nOldRegion, m_nRegionId, m_nMissleId);
	...
	mov	eax, DWORD PTR [edx+368]
	push	eax
	mov	ecx, DWORD PTR _nOldRegion$90534[ebp]
	push	ecx
	push	4002					; 00000fa2H
	mov	edx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [edx+364]
...
; 1607 : 		for (int j = -1; j <= 1; j ++)
	...
	mov	DWORD PTR _j$90557[ebp], -1
	jmp	SHORT $L90558
$L90559:
	mov	ecx, DWORD PTR _j$90557[ebp]
	add	ecx, 1
	mov	DWORD PTR _j$90557[ebp], ecx
$L90558:
	cmp	DWORD PTR _j$90557[ebp], 1
	jg	$L90560
...
; 1619 : 				))
	...
	lea	ecx, DWORD PTR _nSearchRegion$[ebp]
	push	ecx
	mov	edx, DWORD PTR _j$90557[ebp]
	push	edx
	mov	eax, DWORD PTR _i$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1629 : 				nDX = m_nCurrentMapX - Npc[nNpcIdx].m_MapX;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+220]
	sub	edx, DWORD PTR ?Npc@@3PAVKNpc@@A[eax+3552]
...
; 1630 : 				nDY = m_nCurrentMapY - Npc[nNpcIdx].m_MapY;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+224]
	sub	edx, DWORD PTR ?Npc@@3PAVKNpc@@A[eax+3556]
...
; 1632 : 				nNpcOffsetY = Npc[nNpcIdx].m_OffY;
	...
	mov	edx, DWORD PTR _nNpcIdx$[ebp]
	imul	edx, 33616				; 00008350H
	mov	eax, DWORD PTR ?Npc@@3PAVKNpc@@A[edx+3568]
...
; 1666 : 					else if (nDY >0)
	...
	jmp	SHORT $CheckCollision$90567
$L90574:
	cmp	DWORD PTR _nDY$[ebp], 0
	jle	SHORT $CheckCollision$90567
