...
//----���ڲ������ڳ�����ͼ�Ķ����볡����ϵ�Ĳ���----
	...
	// Thu muc goc cua map hien tai (\\v_YYY\\XXX_Region_C.dat nam duoi day).
	// De KAutoPath nap truoc toan bo lop vat can subworld -> A* thay het tuong/cong.
	const char* GetPlaceRootPath() const { return m_szPlaceRootPath; }
