...
#include "Skill.h"
#define MAX_MISSLE_DAMAGEATTRIB 15
...
private:
	...
	BOOL                m_bIsSkillPhysical;//Ngoa.i c鬾g
	BOOL                m_bIsSkillMagic;//No^.i c鬾g
...
private:
	...
	int					CastNotWall					(TOrdinSkillParam * pSkillParam, int nDir, int nRefPX, int nRefPY) const ;
