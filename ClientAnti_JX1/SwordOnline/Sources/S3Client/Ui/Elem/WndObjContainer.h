...
public:
	...
	void DrawLight(int mauvong,int x, int y, int _w, int _h, int unit, int unitboder);
protected:
...
//	KUiDraggedObject	m_Object11;
	

	int					m_nContainerId;
private:
	//khi di chuyen item giua f3 va f4
//	CVongSang	m_vongsang;
};
...
private:
	...
	int GetRectItem(int _w, int _h);
	void DrawPoint(int x, int y, unsigned int wColor);
	void DrawLight(int vongmau,int x, int y, int _w, int _h, int unit, int unitboder);
