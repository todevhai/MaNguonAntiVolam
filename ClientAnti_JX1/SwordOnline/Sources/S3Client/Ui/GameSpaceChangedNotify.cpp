...
#include "UiCase/UiGetStringInUI.h"
...
void CoreDataChangedCallback(unsigned int uDataId, unsigned int uParam, int nParam)
{
	...
	case GDCNI_HOLD_OBJECT:
		...
		break;
	case GDCNI_PLAYER_BASE_INFO:	//���ǵ�һЩ���ױ������
		{
	...
	case GDCNI_PLAYER_RT_ATTRIBUTE:
		...
		break;
	case GDCNI_PLAYER_IMMED_ITEMSKILL://���ǵ�����ʹ����Ʒ���书
		if (uParam)
		{
	...
	case GDCNI_OBJECT_CHANGED:
		...
		break;
	case GDCNI_LIVE_SKILL_BASE:		//�������ֵ�仯
		{
		...
		break;
	case GDCNI_FIGHT_SKILL_POINT:	//ʣ��ս�����ܵ����仯
		{
			KUiSkills* pPad = KUiSkills::GetIfVisible();
			if (pPad)
			{
	...
	case GDCNI_SKILL_CHANGE:			//��������һ������
		...
		break;
/*	case GDCNI_PLAYER_LEADERSHIP:	//����ͳ˧������ص����ݷ����仯
		{
...
*/
	...
	case GDCNI_QUESTION_CHOOSE:
        {
        if (nParam)
        KUiMsgSelNew::OpenWindow((KUiQuestionAndAnswer*)uParam, (KUiNpcSpr*)nParam);
	...
	case GDCNI_CHAT_GROUP:
		...
		break;
	case GDCNI_CHAT_FRIEND:		//������ѷ����仯
		KUiChatCentre::UpdateData(UICC_U_GROUP, 0, nParam);
		break;
	case GDCNI_CHAT_FRIEND_STATUS:	//�������״̬�����仯
...
//		break;
	...
	case GDCNI_OPEN_STRING_BOX:
		KUiGetStringInUI::OpenWindow("Nh�p k� t�","",UIITEM_WAIT_GETNAME,1,512);
		break;
	...
	case GDCNI_SET_ITEM:
		{
			KUiComItem* pCom = KUiComItem::GetIfVisible();
			if (pCom)
			{
				pCom->UpdateItem((KUiObjAtRegion*)uParam,nParam);
			}
		}
		break;
	case GDCNI_VIEW_TREMBLEITEM:
		{
	...
	case GDCNI_GIVE:
		{
			KUiGive::OpenWindow("Giao di�n tr� v�t ph�m nhi�m v�",(char *)uParam,nParam);
		}
		break;		
	case GDCNI_PLAYER_BRIEF_PROP:
		GameWorldTips(uParam, nParam);
		break;
	case GDCNI_NEWS_MESSAGE:		//������Ϣ
		if (uParam)
	...
	case GDCNI_OPEN_TONG_CREATE_SHEET:
		...
		break;
	case GDCNI_OPEN_MARKET:
		KUiMarket::OpenWindow();
		break;
/*	case GDCNI_UPDATE_MARKET:
		{
...
void KClientCallback::MSNMessageArrival(char* szSourceName, char* szSendName, const char* pMsgBuff, unsigned short nMsgLength, bool bSucc)
{
	...
	{
		char szInfo[256];
		int n = sprintf(szInfo, "B�n h�u %s kh�ng c� tr�n m�ng, xin g�i l�i sau !", szSendName);
		KUiMsgCentrePad::SystemMessageArrival(szInfo, n);
		return;
	}
...
#define LEVEL_TIPS_INI "\\Ui\\�ӻ�.ini"
//--------------------------------------------------------------------------
//	���ܣ��ȼ�����ʿ
//--------------------------------------------------------------------------
