...
char g_ActionName[][32] = 
{
	...
	"Theo sau",
	"C�u s�t",
	"Xem trang b�",	// ACTION_VIEWITEM: xin xem trang bi (ban goc ghi "Tin tuc" nen khong ai nhan ra)
	"S� �en",
	"Bang h�i",
};
