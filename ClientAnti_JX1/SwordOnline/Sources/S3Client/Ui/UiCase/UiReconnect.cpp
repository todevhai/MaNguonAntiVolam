...
#define	MSG_RECONNECTING				"Sau <color=red>%d<color> gi©y n÷a tiÕn hµnh kÕt nèi l¹i\n%s..."
#define	MSG_WAIT_TO_RECONNECT			"Sau <color=yellow>%d<color> gi©y n÷a tiÕn hµnh thö kÕt nèi l¹i lÇn <color=red>%d<color>"
#define	MSG_WAIT_NEXT_GROUP_RECONNECT	"%d gi©y n÷a tiÕn hµnh kÕt nèi l¹i...."
