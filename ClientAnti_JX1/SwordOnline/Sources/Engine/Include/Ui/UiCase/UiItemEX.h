...
class KUiItemEX : protected KWndShowAnimate
{
public:
	static KUiItemEX* OpenWindow();		//打开窗口，返回唯一的一个类对象实例
	static KUiItemEX* GetIfVisible();		//如果窗口正被显示，则返回实例指针
...
private:
	static KUiItemEX*		m_pSelf;
private:
	
	KWndButton			m_CloseBtn;
	KWndObjectMatrix	m_ItemEX;
