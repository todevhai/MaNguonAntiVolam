...
class Player_Unlock : public KWndButton
{
public:
	DECLARE_COMCLASS(Player_Unlock)
	void OnButtonClick();
	const char*	GetShortKey();
};
...
class Player_Market : public KWndButton
{
public:
	DECLARE_COMCLASS(Player_Market)
	void OnButtonClick();
	const char*	GetShortKey();
};

class Player_TongKim : public KWndButton
{
public:
	DECLARE_COMCLASS(Player_TongKim)
	void OnButtonClick();
	const char*	GetShortKey();
};
