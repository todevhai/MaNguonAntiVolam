...
public:
	...
	LPDIRECTDRAWSURFACE	m_lpDDSPrimary_Main;
	LPDIRECTDRAWSURFACE	m_lpDDSBackBuf_Main;
	LPDIRECTDRAWCLIPPER m_lpClipper_Main;
	BOOL		m_DirectDrawSub;
public:
	BOOL		CreateDirectDraw();
	BOOL		CreateDirectDrawSub();
	BOOL		CreateClipper();
	BOOL		CreateSurface();
	BOOL		GetSurfaceDesc();
	BOOL		GetDisplayMode();
	...
	BOOL		Init(KDirectDraw* m_DirectDraw);
	void		Exit();
