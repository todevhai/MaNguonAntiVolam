...
//	strcpy(m_szGameSvrIP, OnlineGameLib::Win32::net_ntoa(dwIp));
	...
	cout <<" Intranet IP   :   "<< m_dwIntranetIp <<  endl;
	cout <<" Internet IP   :   "<< m_dwInternetIp << endl;
...
//	net_buffer = new ZBuffer(20240000, 400);
	...
	{
		cout << "- Ket noi den database is failed!" << endl;
		return FALSE;
	}

	cout << " - Ket noi den database thanh cong!" << endl;
	...
	{		
		cout << " - Ket noi den transfer thanh cong!" << endl;	
	}
	...
	{		
		cout << " - Ket noi den chat thanh cong!" << endl;	
	}
...
//------------------------ - Ket noi den tong ----------------------------
	...
	{		
		cout << " - Ket noi den tong thanh cong!" << endl;	
	}
//------------------------ - Ket noi den tong end ----------------------------
	...
	cout << " - Ket noi den gateway thanh cong!" << endl;
	cout << " ___________________________________________" << endl;	

	cout << " Khoi dong gameserver hoan tat" << endl;	
	/*
	 * Game timer start
	 */
	m_Timer.Start();
...
void KSwordOnLineSever::DatabaseMessageProcess(const char* pData, size_t dataLength)
{
	...
	case s2c_roleserver_saverole_result:
		//m_bSaveFlag = TRUE;
		{
			...
			printf("  Luu du lieu nhan vat ID [%d] finished\n", nIndex);
		}
		break;
	default:
		...
		case s2c_syncgamesvr_roleinfo_cipher:
			{
				...
				if ( pGI->datalength > 0 )
				{
					...
					cout << "Ten tai khoan : " << pRoleData->BaseInfo.caccname;
					cout << " - Ten nhan vat : " << pRoleData->BaseInfo.szName << endl;
...
void KSwordOnLineSever::PlayerLogoutGateway()
{
	...
	for (int nIndex = 1; nIndex < MAX_PLAYER; nIndex++)
	{
		// Clear player which - Ket noi den gateway but not - Ket noi den gamesvr
