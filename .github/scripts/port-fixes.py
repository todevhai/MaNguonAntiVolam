...
edit('Engine/Src/KDrawBase.cpp',
     ...
     b'			s_nSangDan = g_DocCuongDo("VLTK_SANG_DAN", g_DocCuongDo("VLTK_SANG", 48));\r\n'
     b'			s_nSangHU  = g_DocCuongDo("VLTK_SANG_HIEU_UNG", g_DocCuongDo("VLTK_SANG", 48));\r\n'
     b'		}\r\n'
     ...
     b'		int nHeSo = (nAlpha >= 255) ? nCuongDo : ((nAlpha >> 3) * nCuongDo >> 5);\r\n'
     ...
     b'					int nA = (nSang * nHeSo) >> 5;\r\n'
     b'					if (nA > 31) nA = 31;\r\n'
     b'					nR = nDR + (((nSR0 - nDR) * nA) >> 5);\r\n'
     b'					nG = nDG + (((nSG0 - nDG) * nA) >> 5);\r\n'
     b'					nB = nDB + (((nSB0 - nDB) * nA) >> 5);\r\n'
     b'					if (nR < 0) nR = 0;\r\n'
     b'					if (nG < 0) nG = 0;\r\n'
     b'					if (nB < 0) nB = 0;\r\n'
     b'				}\r\n'
