...
edit('Engine/Src/KDrawBase.cpp',
     ...
     b'		/* 40 chu khong phai 32 (nguyen ven): do anh ban hoan thien 12/09/2026 thay\r\n'
     b'		   hieu ung cua ho sang hon han (val 0.75-0.84 so voi 0.63-0.73 cua ta).\r\n'
     b'		   Phan chenh den tu cho ho ve NHIEU sprite chong len nhau luc trung dich,\r\n'
     b'		   thu ta chua tai lap duoc; nang cuong do la cach bu gan nhat. Do lai:\r\n'
     b'		   chieu 15x val 0.833 (ban6 0.844), chieu 8x val 0.796 (ban6 0.750),\r\n'
     b'		   chay trang 0.8%% - khong bi loe. */\r\n'
