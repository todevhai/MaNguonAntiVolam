...
edit('Core/Src/CoreShell.cpp',
     ...
     _crlf(b'/* ---- Tim duong cho lenh bam ban do (xem ghi chu o port-fixes) ---- */\n'
           ...
           b'\t\tSubWorld[0].Map2Mps(Npc[nIdx].m_RegionIndex, Npc[nIdx].m_MapX, Npc[nIdx].m_MapY, 0, 0, pnX, pnY);\n'
           b'}\n'
           b'\n'
           b'static int TD_DiDuoc(int nX, int nY)\n'
           b'{\n'
           b'\treturn SubWorld[0].TestBarrier(nX, nY) == 0;\n'
           b'}\n'
           b'\n'
           ...
           b'\ts_nSoChang = 0;\n'
           b'\ts_nChangDang = 0;\n'
           b'\ts_nTDGocX = ((nTuX + nDenX) / 2) - (defTD_CANH / 2) * defTD_O;\n'
           b'\ts_nTDGocY = ((nTuY + nDenY) / 2) - (defTD_CANH / 2) * defTD_O;\n'
           b'\n'
           ...
           b'\tif (s_nSoChang <= 0)\n'
           b'\t\treturn 0;\n'
           b'\t/* Chang cuoi lay dung diem nguoi choi bam. */\n'
