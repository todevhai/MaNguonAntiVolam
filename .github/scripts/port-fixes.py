...
edit('Engine/Src/KDrawBase.cpp',
     ...
     b'	int bLa565 = (pCanvas->m_nMask32 == 0x07e0f81f);\r\n'
     ...
     b'		                nen sang (dat)\r\n'
     b'		     ban6     - MAC DINH: screen 5 bit y nhu KCanvas::DrawSpriteScreen cua\r\n'
     b'		                ban hoan thien, alpha doan chi dung de bo qua diem\r\n'
     ...
     b'		/* 32 = NGUYEN VEN, dung y phep cua ban hoan thien. Da thu nang len 40 cho\r\n'
     b'		   sang bang anh ban6 (val 0.75-0.84 so voi 0.63-0.73 cua ta), nhung nhan\r\n'
     b'		   nguon len roi ket qua screen CHAM TRAN theo tung kenh -> loi hieu ung\r\n'
     b'		   chay trang, mat mau. User bao 12/09/2026 khi thay chieu cua quai.\r\n'
     b'		   Phan sang con thieu den tu cho ban hoan thien ve NHIEU sprite chong len\r\n'
     b'		   nhau luc trung dich, khong phai tu cuong do - dung bu bang cach nhan. */\r\n'
